...
## Figure 1
This map shows the percentage of the population in each administrative region that was born abroad. Most foreign-born persons live near Helsinki (the yellow part of the map) and there is very little immigration outside of this region. It's not a very interesting map because of this!
```{r}
...
## Figure 5
Finally, I made a centeroid map depicting the number of persons born abroad with varying sizes of circles. 
```{r}
