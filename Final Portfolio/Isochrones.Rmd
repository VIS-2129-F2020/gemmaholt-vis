...
isochrone_10min <- ggplot(iso_10min_walk) +
  ...
  ggtitle("10-minute Walkshed from Vancouver libraries")

isochrone_10min

png(file="C:/Users/gemma/OneDrive/GSD Semester 1/Spatial Analysis/Final Portfolio/Figures/isochrone_10min.png",
width = 6,
  height    = 4,
  units     = "in",
  res       = 1000)
...
isochrone_walkbike <- ggplot(iso_walk_bike) +
  annotation_map_tile(zoomin = 0, type = "cartolight", progress = "none") +
  geom_sf(aes(fill = mode), alpha = 0.5) +
  geom_sf(data = van_libraries) +
  coord_sf(xlim = c(left_side, right_side), 
  ...
  theme_map() +
  labs(caption = "Basemap Copyright OpenStreetMap contributors")+
  ggtitle("10-minute Walkshed and 10-minute Bikeshed from Vancouver libraries")

isochrone_walkbike

png(file="C:/Users/gemma/OneDrive/GSD Semester 1/Spatial Analysis/Final Portfolio/Figures/isochrone_walkbike.png",
width = 6,
  height    = 4,
  units     = "in",
  res       = 1000)
...
isochrone_libraries <- ggplot(iso_10min_walk) +
  annotation_map_tile(zoomin = 0, type = "cartolight", progress = "none") +
  geom_sf() +
...
png(file="C:/Users/gemma/OneDrive/GSD Semester 1/Spatial Analysis/Final Portfolio/Figures/isochrone_libraries.png",
width = 6,
  height    = 4,
  units     = "in",
  res       = 1000)
...
isochrone_schools <- ggplot(iso_10min_walk) +
  annotation_map_tile(zoomin = 0, type = "cartolight", progress = "none") +
...
png(file="C:/Users/gemma/OneDrive/GSD Semester 1/Spatial Analysis/Final Portfolio/Figures/isochrone_schools.png",
width = 6,
  height    = 4,
  units     = "in",
  res       = 1000)
